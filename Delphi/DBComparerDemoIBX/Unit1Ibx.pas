...
uses
  ...
  ExtCtrls, IBDatabase, dbcDBComparer, dbcDBStructure,
  dbcIBDatabaseExtract, dbcClasses, dbcIBScriptExtract,
  dbcSQL_Exec, dbcIBSQLExec, ComCtrls,
  dbcDBEngine, dbcConnection_IBX, dbcCustomScriptExtract,
...
Uses IBDataModuleIbx, IniFiles, dbcCompObj;
